...
namespace Encryption
{
    class Program
    {
        ...
        public static void DecryptPDF()
        {
            ...
            string fileName = @"C:\Users\19139\Downloads\PO-encrypted.pdf";
            ...
            File.WriteAllBytes(@"C:\Users\19139\Downloads\PO-Decrypted.pdf", allBytes);
            //string decryptedText = reader.ReadToEnd(); // Read all the way to the end and output as a string
